...
const ForgotPassword = () => {
  ...
  const handleOtpSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("https://empbackend.vercel.app/auth/forgotpassword", {
        email,
      });
  ...
  const handleResetPassword = async (event) => {
    event.preventDefault();
    try {
      const response = await axios.post("https://empbackend.vercel.app/auth/resetpassword", {
        email,
        otp,
