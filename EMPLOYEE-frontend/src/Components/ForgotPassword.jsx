...
const ForgotPassword = () => {
  ...
  const handleOtpSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("https://employee-login-backend.vercel.app/admin/", {
        email,
      });
  ...
  const handleResetPassword = async (event) => {
    event.preventDefault();
    try {
      const response = await axios.post("https://employee-login-backend.vercel.app/admin/auth/resetpassword", {
        email,
        otp,
